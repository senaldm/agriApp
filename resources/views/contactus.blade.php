...
<body class="bg-gray-800 text-gray-100 px-8 py-12">
    ...
    <div
      class="max-w-screen-xl mt-3 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
      <div class="flex flex-col justify-between">
        <div>

          <h3 class="text-2xl lg:text-5xl font-semibold leading-tight mt-8 ">Let's talk about our Web Application.</h2>
          <h2 class="text-2xl lg:text-2xl font-semibold leading-tight mt-1 font-serif">Please send us your queries & valuable feedbacks.</h2>
        </div>
      ...
      <div class="">
        <form name="Subscribe" id="Subscribe" method="post" action="{{url('store-feedback')}}">
            @csrf
        <div>
          <span class="uppercase text-sm text-gray-600 font-semibold">Full Name</span>
          <input class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
            type="text"  id="name" name="name" placeholder="Enter your full name">
        </div>
        <div class="mt-8">
          <span class="uppercase text-sm text-gray-600 font-semibold">Email</span>
          <input class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
            type="text" id="email" name="email" placeholder="Enter your e-mail">
        </div>
        <div class="mt-8">
          <span class="uppercase text-sm text-gray-600 font-semibold">Message</span>
          <textarea
            class="w-full h-32 bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" id="feedback" name="feedback" placeholder="We value your feedbacks"></textarea>
        </div>
        <div class="mt-8">
          <button
            class="uppercase text-base font-semibold tracking-wide focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-ou bg-indigo-500 text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline" type="submit" >
            Send Message
          </button>
        </form>
