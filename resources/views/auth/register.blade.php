...
<section>
    <nav class="bg-red-300 border-gray-200 px-2 sm:px-4 mb-4 rounded dark:bg-blue-500">
        <div class="container flex flex-wrap justify-between items-center mx-auto">
          <a href="" class="flex items-center">
              ...
              <span class="self-center text-lg font-semibold whitespace-nowrap dark:text-blue font-serif"> Agriculture Products Management System - Registering Console</span>
          </a>
          <button data-collapse-toggle="mobile-menu" type="button" class="inline-flex items-center p-2 ml-3 text-base text-gray-500 rounded-lg md:hidden  focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-blue-500 dark:focus:ring-gray-600" aria-controls="mobile-menu" aria-expanded="false">
                ...
                <a class="inline-block text-black no-underline hover:text-white hover:text-underline py-2 px-3 font-bold font-serif" href="/login">Sign in</a>
          </button>
    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="contact_no" class="block mt-1 w-full" type="text" name="contact_no" :value="old('contact_no')"  required autocomplete="contact_no" />
            </div>
...
<!-- This php code should be included to register controller file -->
<?php
