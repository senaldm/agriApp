<x-app-layout>
    <div class="pt-5 min-h-screen  bg-repeat-x " style= "background-image:url(https://i.pinimg.com/564x/c3/ab/7a/c3ab7a9954e439a20dd2ca89b4566c0d.jpg);">
        ...
        <div class="flex items-center justify-center ">
            <div>
                <button class="bg-green-200 animate-bounce px-6 py-1  text-black  hover:bg-blue-300 border-l font-bold rounded-full text-xl border-black border-2 flex items-center justify-centercClass Properties
        ...
        <p class="text-left text-2xl font-semibold text-white px-7 ml-5 font-serif animate-pulse pt-5 "> <mark> Hurry....Choose your Products Now!!!!</mark> </p>
        <div class="container">
            <div class="container ">
                @if(session('status'))
...
<html lang="en">
  ...
  <body class="leading-normal tracking-normal text-white gradient mb-8" style="font-family: 'Source Sans Pro', sans-serif;">
    <!--Nav-->
    ...
    <div class="container max-w-6xl mx-auto">
        ...
        <div class="grid grid-cols-4 gap-8 mt-10 sm:grid-cols-8 lg:grid-cols-12 sm:px-8 xl:px-0">
            ...
            <div class="relative flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 overflow-hidden bg-gray-100 sm:rounded-xl">
                ...
                <p class="text-base text-center text-gray-500">We provide instant Chat service between our users. A Customer can contact  a seller at any time via our Chatify messaging Feature. </p>
            </div>
    ...
    <div>
        <div >
            <div class="md:flex">
                ...
                <div class="relative"> <input type="text" id="email" name="email"  required="" class="bg-blue-700 h-14 w-full px-4 pr-20 rounded-md focus:outline-none hover:cursor-pointer" name="">
