...
<div class="row">
    ...
    <body class="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover" style="background-image:url('https://png.pngtree.com/thumb_back/fh260/background/20190221/ourmid/pngtree-business-enterprise-annual-meeting-champion-image_23063.jpg');">
        <button type="submit" class=" ml-14 hover: gradient text-grey-500 font-bold rounded-full my-6  px-3 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out" onclick="location.href='/Bid1'">
            Go Back
          </button>
        <div class="col-xs-18 col-sm-6 ">
            <div class="product_box">
                ...
                <div class="caption">
                    ...
                    <p class="font-weight-bold text-white ml-12 mt-2 text-lg font-serif font-semibold"> Seller Contact Number - 0{{ $bidsdetail->seller_phone}} </p>
