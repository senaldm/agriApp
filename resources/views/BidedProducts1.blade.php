...
<div class="row">
    ...
    <body class="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover" style="background-image:url('https://png.pngtree.com/thumb_back/fh260/background/20190221/ourmid/pngtree-business-enterprise-annual-meeting-champion-image_23063.jpg');">
        <button type="submit" class=" ml-14 hover: gradient text-grey-500 font-bold rounded-full my-6  px-3 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out" onclick="location.href='/Bid'">
            Go Back
          </button>
