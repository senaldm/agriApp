...
<div class=" w-full cursor-pointer rounded-md shadow-md shadow-gray-200 hover:shadow-blue-400 hover:shadow-2xl hover:bg-gray-50">
    ...
    <div class="p-2">
    <div>
        <form name="Bid" id="Bid" method="post" action="{{route('biding1', $product->id)}}">
            @csrf
        <div class>
