...
<html lang="en">
  ...
  <body class="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover" style="background-image:url('https://cloudfront-us-east-1.images.arcpublishing.com/coindesk/WOPZ6KFSERH35IMFR3SKPSNY7M.jpg');">
    <button type="submit" class=" mt-10 ml-14 mb-7 hover: gradient text-grey-500 font-bold rounded-full   px-3 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out" onclick="location.href='/Bid'">
        Go Back
      </button>
