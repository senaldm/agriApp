        ...
        <div class="col-xs-18 col-sm-6 col-md-3">
            <div class="product_box">
                ...
                <div class="caption">
                    ...
                    <button type="submit active" class=" mt-3 btn btn-warning text-center" onclick="location.href='{{ route('BidEdit1', $product->id) }}' "> <strong>Edit Date
                        </strong> </a></button>
                    <button type="submit active" class=" mt-3 btn btn-primary  text-center" onclick="location.href='{{ route('BidHigh1', $product->id) }}'">
